...
//  Rick and Morty
//
//  Created by Tai Nguyen on 21/01/2021.
//
...
class CharacterTableViewController: UITableViewController {
    ...
    lazy var adapter: NativeViewModel = NativeViewModel(
            viewUpdate: { [weak self] nameList in
                self?.viewUpdate(for: nameList)
            }
        )
...
//    ]
    ...
    private func viewUpdate(for nameList: [String]) {
        contacts += nameList
